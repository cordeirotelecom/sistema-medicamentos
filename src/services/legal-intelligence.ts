  ...
  private static readonly RECENT_NEWS: NewsItem[] = [
    {
      ...
      fullContent: 'A ANVISA autorizou o registro de três novos medicamentos biossimilares para tratamento oncológico, incluindo versões genéricas de bevacizumabe, trastuzumabe e rituximabe, conforme Resolução RDC nº 899/2025.',
      source: 'anvisa',
      category: 'regulacao',
      date: '2025-01-20',
      url: 'https://www.anvisa.gov.br/noticias/2025/biossimilares-oncologia',
      relevance: 'alta',
      tags: ['biossimilares', 'oncologia', 'aprovação', 'sus'],
      impact: {
        scope: 'nacional',
        urgency: 'curto_prazo',
        legalImplications: [
