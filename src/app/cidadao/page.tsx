...
export default function CidadaoPage() {
  ...
  const handleFormSubmit = async (formData: any) => {
    ...
    try {
      ...
      alert('Erro ao processar consulta. Tente novamente em alguns instantes.');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 w-full">
        ...
        <div className="w-full px-2 sm:px-4 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            <div className="flex items-center space-x-2 sm:space-x-4">
              <Link href="/" className="flex items-center space-x-1 sm:space-x-2 text-gray-600 hover:text-blue-600 transition-colors bg-gray-50 hover:bg-blue-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600">Sistema de Orientação Medicamentosa</p>
              </div>
            </div>
      ...
      {/* Main Content */}
      <main className="w-full px-2 sm:px-4 lg:px-8 py-6 sm:py-12">
        <div className="max-w-6xl mx-auto w-full">
        {currentStep === 'form' && (
          <div className="w-full space-y-4 sm:space-y-6">
            {/* Hero Section Simplificada */}
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 border border-blue-200">
